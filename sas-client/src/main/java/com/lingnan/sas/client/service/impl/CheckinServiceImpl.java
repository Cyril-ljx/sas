...
import com.lingnan.sas.client.service.CheckinService;
import com.lingnan.sas.client.task.EmailTask;
...
@Scope("prototype")//要发送邮件所以设置为多例的功能，设置异步功能比较省时
@Slf4j
public class CheckinServiceImpl implements CheckinService {
    ...
    @Value("${sas.face.createFaceModelUrl}")
    private String createFaceModelUrl;

    @Value("${sas.face.checkinUrl}")
    ...
    public String validCanCheckIn(int userId, String date) {
        ...
        if (type.equals("节假日")) {
            ...
            String start = DateUtil.today() + " " + constants.attendanceStartTime;//今天的日期
    ...
    public void checkin(HashMap param) {
        ...
        //当前时间大于上班时间但小于打卡时间
            ...
            throw new ClientException("超出考勤时间段，无法考勤");
        }
        int userId= (Integer) param.get("userId");
        String faceModel=faceModelDao.searchFaceModel(userId);
        if(faceModel==null){
            throw new ClientException("不存在人脸模型");
        }
        else{
            ...
            if(response.getStatus()!=200){
                log.error("人脸识别服务异常");
                throw new ClientException("人脸识别服务异常");
            }
            ...
            if("无法识别出人脸".equals(body)||"照片中存在多张人脸".equals(body)){
                ...
                throw new ClientException("签到无效，非本人签到");
            }
...
//                            result="高风险";
                        ...
                        log.error("执行异常",e);
                        throw new ClientException("获取风险等级失败");
                    }
                }
                //保存签到记录
