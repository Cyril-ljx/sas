package com.lingnan.sas.client.util;
...
public class TencentCOS {
    ...
    // 此处填写的存储桶名称
    private static final String bucketName = "lulu0921-1305401030";
    // secretId
    private static final String secretId = "AKIDbzbyhByfc1DBsLH1EF0sXzMTgfR2qXih";
    // secretKey
    private static final String secretKey = "rnUyDCyQhz3sRkQ6XAD2artoUt4UaSRY";
